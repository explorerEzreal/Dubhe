import { z } from 'zod';
import { MODEL_INSTANCE_STATES } from '../../domain/model-state.js';
import type { ModelInstanceState } from '../../domain/model-state.js';
...
export const registeredMessageSchema = envelopeSchema.extend({
...
// 保留运行时旧导出名，避免影响现有调用方。
export const inferRequestSchema = inferRequestMessageSchema;
export const inferChunkSchema = inferChunkMessageSchema;
export const inferCancelSchema = inferCancelMessageSchema;
