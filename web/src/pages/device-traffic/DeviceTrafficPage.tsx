...
export function DeviceTrafficPage() {
  ...
  return <section>
    <div className='dashboard-header'><div><Typography.Title level={1}>流量监控</Typography.Title><Typography.Paragraph type='secondary'>按分组、调用用户、API Key、模型和设备观察 Token 消耗与请求质量。</Typography.Paragraph></div><Space><DatePicker.RangePicker value={range} allowClear={false} onChange={handleRangeChange} /></Space></div>
